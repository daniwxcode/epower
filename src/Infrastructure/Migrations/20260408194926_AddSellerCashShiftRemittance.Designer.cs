...
namespace BlazorHero.CleanArchitecture.Infrastructure.Migrations
{
    ...
    [Migration("20260408194926_AddSellerCashShiftRemittance")]
    partial class AddSellerCashShiftRemittance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Bail.CashRemittance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CashRemittances");
                });

            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Bail.CashShift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Bail.RentalAgreement", b =>
                {
                    ...
                    b.Property<double?>("EndDateCounterValue")
                        .HasColumnType("float");
                    ...
                    b.Property<int>("ShopTenantId")
                        .HasColumnType("int");

                    b.Property<DateTime>("StartDate")
                        .HasColumnType("datetime2");

                    b.Property<double>("StartDateCounterValue")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("ShopTenantId");

                    b.ToTable("RentalAgreements");
                });

            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Bail.Seller", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Bail.ShopTenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Bail.CashRemittance", b =>
                {
                    b.HasOne("BlazorHero.CleanArchitecture.Domain.Entities.Bail.CashShift", "CashShift")
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Bail.CashShift", b =>
                {
                    b.HasOne("BlazorHero.CleanArchitecture.Domain.Entities.Bail.Seller", "Seller")
                        .WithMany("CashShifts")
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Entities.Bail.RentalAgreement", b =>
                {
                    ...
                    b.HasOne("BlazorHero.CleanArchitecture.Domain.Entities.Bail.ShopTenant", "ShopTenant")
                        .WithMany("RentalAgreements")
                        .HasForeignKey("ShopTenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Shop");

                    b.Navigation("ShopTenant");
                });
