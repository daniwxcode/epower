...
public static partial class DataConverter
{
    ...
    public static PayementResponseBase GetPayementResponse(this Payment payment) => new PayementResponseBase(payment.Id, payment.CreatedOn, payment.Amount, payment.SerialNumber, null, payment.CreatedBy);
    public static PayementResponseBase GetPayementResponse(this Payment payment, int meterId) => new PayementResponseBase(payment.Id, payment.CreatedOn, payment.Amount, payment.SerialNumber,meterId, payment.CreatedBy);
    public static PayementResponseBase GetPayementResponse(this InternalPayement p) => p.GetPayementResponse(p.MeterId);
